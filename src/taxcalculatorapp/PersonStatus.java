    ...
    public class PersonStatus {
        ...
        public void SinglePersonTax() throws IOException{
            ...
            // variables
            double taxPayble_20 = 0;
            double taxPayble_40 = 0;
                    ...
                    switch (paymentFrequency){
                        ...
                        double hoursPerWeek = userDouble.getUserDouble();//Double.parseDouble(myKeyboard.readLine());
                           ...
                           if (weeklyGrossPay > weeklyPayLimit.getWeeklyPayLimit()){
                            ...
                            // CALCULATING PRSI
                            System.out.println("PRSI DEDUCTIONS > " + PRSI_tax.getPRSI_Tax(weeklyGrossPay));
                            ...
                            // 5) finding Tax Payable 20%
                            taxPayble_20 = grossDeduction - taxCredits.getWeeklyTaxCredits(userTax);
                            ...
                            taxPayble_40 = remainingBalance * this.emergency_tax / this.percentage;
                            System.out.format("NET DEDUCTIONS 40 = %.2f\n", taxPayble_40);
                            ...
                            System.out.println("Therefore your NET PAY for ( " + companyName[i] + " ) is: \u20ac " + df.format(NET_PAY) + " for this period " + "\n"); 
                               ...
                               // 1) finding gross deductions (Gross pay * 20% / 100%) using weekly gross pay
                                double grossDeduction = weeklyGrossPay * this.regular_tax / this.percentage;
                                
                                // 2) finding Tax Payble
                                double taxPayable = grossDeduction - taxCredits.getWeeklyTaxCredits(userTax);
                                
                                // 4) finding net pay 20%
